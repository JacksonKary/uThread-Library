...
int main(int argc, char* argv[]){
    ...
    */
    ...
    if(wfd = open("tests/copy.txt", O_WRONLY|O_APPEND|O_CREAT,0666) <=0){
        perror("Cannot write to the file");
    }
    else wfd = open("tests/copy.txt", O_WRONLY|O_CREAT,0666);
    ...
    */
    ...
    if(wfd = open("tests/aio_copy.txt", O_WRONLY|O_APPEND|O_CREAT,0666) <=0){
        perror("Cannot write to the file");
    }
    else wfd = open("tests/aio_copy.txt", O_WRONLY|O_CREAT,0666);
